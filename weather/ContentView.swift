...
struct ContentView: View {
    ...
    var body: some View {
        ZStack {
            ...
            VStack {
                CityTextView(cityName: "Busan")
                
                MainWeatherStatusView(imageName: isNight ? "moon.stars.fill" : "sun.max.fill", temperature: 76)
            
                
                HStack(spacing: 20) {
                    WeatherDayView(dayOfWeek: "THE", imageName: "cloud.sun.fill", temperature: 74)
